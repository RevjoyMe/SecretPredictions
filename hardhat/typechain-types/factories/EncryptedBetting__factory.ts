...
import type {
  EncryptedBetting,
  EncryptedBettingInterface,
} from "../EncryptedBetting";
...
type EncryptedBettingConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: EncryptedBettingConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class EncryptedBetting__factory extends ContractFactory {
  constructor(...args: EncryptedBettingConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): EncryptedBetting__factory {
    return super.connect(runner) as EncryptedBetting__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): EncryptedBettingInterface {
    return new Interface(_abi) as EncryptedBettingInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): EncryptedBetting {
    return new Contract(address, _abi, runner) as unknown as EncryptedBetting;
  }
}
